...
import com.nnorom.thriftwears.databinding.UploadBinding
import com.nnorom.thriftwears.item.ProductItem
import com.nnorom.thriftwears.item.UploadedImagesItem
...
class Upload : Fragment() {
    ...
    private fun saveItemToFireStore(productItem: ProductItem) {
        ...
        productItem.category = productItem.category!!.lowercase()
